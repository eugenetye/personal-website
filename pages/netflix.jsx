        ...
        <div className='w-full'>
            <div className='w-screen h-[30vh] lg:h-[40vh] relative'>
                <div className='absolute top-0 left-0 w-full h-[30vh] lg:h-[40vh] bg-black/80 z-10' />
                    <Image className='absolute z-1' layout='fill' objectFit='cover' src={nextflixImg} alt='/' />
            ...
            <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8'>
                <div className='col-span-4'>
                    ...
                    <p>This app is built using JavaScript. This app is built using JavaScript. This app is built using JavaScript. This app is built using JavaScript.</p>
